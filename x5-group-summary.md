...
本次使用的后台框架为flask，使用起来比较简单。一个开发中的小难点是注册时获取的验证码如何保存。直接保存在内存中效率最高，但是需要考虑定时对其进行清理，还有一些多用户，并发的问题需要解决。具体见[定时清理验证码的一种解决方案](https://blog.csdn.net/Runner1st/article/details/93361274)

[个人小结](https://blog.csdn.net/Runner1st/article/details/93359035)
